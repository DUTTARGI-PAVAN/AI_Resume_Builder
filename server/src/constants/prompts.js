...
JOB DESCRIPTION:
${data.jobDescription || 'No job description provided. Score the uploaded resume by ATS readiness, structure, clarity, keyword richness, and completeness. Do not require job-specific missing keywords.'}
...
If no job description is provided, score "keywordMatch" as resume keyword richness and role-relevant terminology, return an empty missingKeywords array, and keep suggestions focused on improving the resume itself.
